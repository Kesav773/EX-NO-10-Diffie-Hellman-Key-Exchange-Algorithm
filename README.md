...
printf("Enter the value of P: "); scanf("%lld",
CP);
printf("The value of P: %lld\n", P);
printf("Enter the value of G (Primitive root of P): "); scanf("%lld",
CG);
...
```
## Output:
<img width="698" height="456" alt="image" src="https://github.com/user-attachments/assets/ef20543e-dc80-4b48-8794-591f5f48a2f5" />
